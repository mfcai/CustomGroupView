...
//            Log.i(TAG, "onViewReleased:" + "xvel:" + xvel + ",yvel:" + yvel);
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            Log.d(TAG, "onViewPositionChanged: mDragOffset:" + mDragOffset+",(mParentHeight - mDrawerHeight - mBottomHeight):"
                    +(mParentHeight - mDrawerHeight - mBottomHeight)+",top:"+top+",mDrawerHeight:"+mDrawerHeight);
