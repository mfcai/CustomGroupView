...
import com.cmf.customgroupview.view.AnchorView;
import com.cmf.customgroupview.view.CustomScrollView;
                ...
                if (isScroll) {
                    for (int i = tabTxt.length - 1; i >= 0; i--) {
                        ...
                        if (y > anchorList.get(i).getTop() - 10) {
                            Log.d("caimingfu"," anchorList.get(i).getTop():"+ anchorList.get(i).getTop()+",y:"+y+",oldy:"+oldy);
                            setScrollPos(i);
                            break;
                        }
                    }
